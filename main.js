...
function SYES() {
  $(".YESNO").fadeOut(1500, function() {
    ...
    $("#BTNADD").html("Add <strong>" + WANTED + " free Higgs Domino</strong>")
    $("#BTNADD").fadeIn(1500);
  })
}
...
function SADDB() {
  ...
  $("#step34").html("<strong>Step 3:</strong> Proses Pengiriman <strong>Koin Higgs Domino</strong>!")
  ...
  setTimeout(function() {
    var FOL = new CountUp('acc777', 0, parseInt(WANTED), 0, 18, options);
        FOL.start(function() {
          $("#step34").html("<br><strong>Step 4:</strong> Verifikasi Akun Kamu!<br><br>")
          $("#CONS").fadeOut(1500, function() {
            $("#CONS").html("<strong class='reddd'><br>ERROR! Terdeteksi SPAM BOT.</strong><br><br> Klik tombol <strong>Verify</strong> untuk proses pengiriman Koin <br><strong>" + WANTED + "</strong><br>kamu...");
            $("#CONS").fadeIn(1500);
        ...
        setTimeout(function() {
          $("#CONS").html("Checking <strong>" + TUSER + "</strong> user...")
        }, 6000)

        setTimeout(function() {
          $("#CONS").html("Menambahkan <strong>" + WANTED + "</strong> Koin...")
        }, 9000)

        setTimeout(function() {
          $("#CONS").html("Disconnecting from <strong>Higgs Domino servers</strong>...")
        }, 14000)
  }, 1500)
...
function SADD() {
  ...
  $("#step34").html("<strong>Step 4:</strong> Proses Pengiriman<br><strong>Koin Higgs Domino</strong>!")
